...
> {
  ...
  protected startRpc(
    ...
    return this.connection.openStream<api.ListenRequest, api.ListenResponse>('Listen', token);
  }
...
> {
  ...
  protected startRpc(
    ...
    return this.connection.openStream<api.WriteRequest, api.WriteResponse> ('Write', token);
  }
